...
persona = sprites.create(img`
    ...
    8 8 f f f f f 8 8 f f f f 8 8 . 
    8 8 8 8 9 8 8 8 8 8 9 8 8 8 8 . 
    8 f f f 8 8 8 8 8 8 8 8 f f 8 . 
    8 8 f f 8 8 8 8 8 8 8 f f 8 8 . 
    8 8 8 f f f 8 8 8 f f f 8 8 8 . 
    8 8 8 8 f f f f f f f 8 8 8 8 . 
    . 8 8 8 8 8 8 f f 8 8 8 8 8 . . 
    . 8 8 8 8 8 8 8 8 8 8 8 8 8 . . 
    . . 8 8 8 8 8 8 8 8 8 8 8 . . . 
    . . . . 8 8 8 8 8 8 8 . . . . . 
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
persona.setVelocity(60, 50)
controller.moveSprite(persona)
let dolent = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . 3 3 3 3 3 3 3 . . . . . 
    . . . 3 3 3 3 3 3 3 3 3 . . . . 
    . . 3 3 3 3 3 3 3 3 3 3 3 . . . 
    . 3 3 3 3 3 3 3 3 3 3 3 3 3 . . 
    . 3 3 f f 3 3 3 3 f f 3 3 3 . . 
    . 3 3 f f 3 3 3 3 f f 3 3 3 . . 
    . 3 3 3 3 3 3 3 3 3 3 3 3 3 . . 
    . 3 3 3 f f f f f f f 3 3 3 . . 
    . 3 3 f f 3 3 3 3 f f f 3 3 . . 
    . 3 3 f 3 a a a a 3 3 f 3 3 . . 
    . . 3 f f 3 3 3 3 3 f f 3 . . . 
    . . . 3 3 3 3 3 3 3 3 3 . . . . 
    . . . . 3 3 3 3 3 3 3 . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
dolent.setPosition(136, 10)
dolent.follow(persona, 50)
